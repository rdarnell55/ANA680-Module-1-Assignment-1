...
# MODEL: RANDOM FOREST CLASSIFIER ESTIMATORS = 10
# In[21]:
...
# ============================
# 5. RANDOM FOREST CLASSIFIER ESTIMATORS = 10
# ============================
# Apply a Random Forest with 10 estimators to classify tumor types as benign or malignant
from sklearn.ensemble import RandomForestClassifier
rf_model = RandomForestClassifier(n_estimators=10, random_state=42)
evaluate_model(rf_model, "Random Forest")

# ============================
# 6. MODEL PERFORMANCE SUMMARY FOR RANDOM FOREST
# ============================
...
rf_results = {
    ...
    'Confusion Matrix': [confusion_matrix(y_test, rf_model.predict(X_test))]
}

results_df = pd.DataFrame(rf_results)
print("Summary of Random Forest Model Performance:")
print(results_df)

# Optional: Save results to CSV
# results_df.to_csv("random_forest_results_summary.csv", index=False)
