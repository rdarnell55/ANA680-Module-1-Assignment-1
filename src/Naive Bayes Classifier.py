...
# ============================
# Apply Gaussian Naive Bayes classifier to classify tumor types as benign or malignant
from sklearn.naive_bayes import GaussianNB
nb_model = GaussianNB()
evaluate_model(nb_model, "Naive Bayes")

# ============================
# 6. MODEL PERFORMANCE SUMMARY FOR NAIVE BAYES
# ============================
...
nb_results = {
    ...
    'Confusion Matrix': [confusion_matrix(y_test, nb_model.predict(X_test))]
}
...
# results_df.to_csv("naive_bayes_results_summary.csv", index=False)
