...
# MODEL: SUPPORT VECTOR MACHINE (SVM) - KERNEL = LINEAR 
# In[20]:
...
# ============================
# Apply SVM with a linear kernel to classify tumor types as benign or malignant
from sklearn.svm import SVC
svm_model = SVC(kernel='linear')
evaluate_model(svm_model, "SVM (Linear Kernel)")

# ============================
# 6. MODEL PERFORMANCE SUMMARY FOR SVM (LINEAR KERNEL)
# ============================
...
svm_results = {
    ...
    'Confusion Matrix': [confusion_matrix(y_test, svm_model.predict(X_test))]
}

results_df = pd.DataFrame(svm_results)
print("Summary of SVM (Linear Kernel) Model Performance:")
print(results_df)

# Optional: Save results to CSV
# results_df.to_csv("svm_linear_results_summary.csv", index=False)
