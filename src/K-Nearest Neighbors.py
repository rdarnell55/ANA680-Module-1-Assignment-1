...
# ============================
# Apply KNN with k=5 to classify tumor types as benign or malignant
from sklearn.neighbors import KNeighborsClassifier
knn_model = KNeighborsClassifier(n_neighbors=5)
evaluate_model(knn_model, "K-Nearest Neighbors (k=5)")

# ============================
# 6. MODEL PERFORMANCE SUMMARY FOR K-NEAREST NEIGHBORS
# ============================
...
knn_results = {
    ...
    'Confusion Matrix': [confusion_matrix(y_test, knn_model.predict(X_test))]
}

results_df = pd.DataFrame(knn_results)
print("Summary of K-Nearest Neighbors Model Performance:")
print(results_df)

# Optional: Save results to CSV
# results_df.to_csv("knn_results_summary.csv", index=False)
