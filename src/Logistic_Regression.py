...
# ============================
# Apply Logistic Regression to classify tumor types as benign or malignant
from sklearn.linear_model import LogisticRegression
lr_model = LogisticRegression()
evaluate_model(lr_model, "Logistic Regression")

# ============================
# 6. MODEL PERFORMANCE SUMMARY FOR LOGISTIC REGRESSION
# ============================
...
lr_results = {
    ...
    'Confusion Matrix': [confusion_matrix(y_test, lr_model.predict(X_test))]
}

results_df = pd.DataFrame(lr_results)
print("Summary of Logistic Regression Model Performance:")
print(results_df)

# Optional: Save results to CSV
# results_df.to_csv("logistic_regression_results_summary.csv", index=False)
